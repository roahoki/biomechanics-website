        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
            ...
            <div className="pt-2 border-t border-gray-100">
                <div className="text-xs text-gray-500">
                    {!product.title && <span className="text-red-500">• Título requerido</span>}
                    {product.price === 0 && <span className="text-red-500 block">• Precio requerido</span>}
                    {!product.paymentLink && <span className="text-red-500 block">• Link de pago requerido</span>}
                    {product.images.length === 0 && <span className="text-amber-500 block">• Se recomienda al menos 1 imagen</span>}
                </div>
            </div>
        </div>
    )
